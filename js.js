...
const textToToolTIp = [
    ['На трупе Наемника Тартуччио','На трупе разбойника, в южной части локации',
        'Попасть можно либо после выполнения квеста привратницы Квогги' +
    ...
    'вагонеткой завал', 'В северо-восточной части карты, на берегу подземного озера','Перед бродом с ловушками',
        'На восточном берегу острова, проверка внимания +16', 'В юго-восточном углу карты'],
    ...
    ['В сундуке западней моста на юге карты, плутовство +16','У разбойника в северо-западной части карты',
        ...
        'В северо-западном углу карты', 'В хижине вождя', 'В центре карты, проверка внимание +3',
    ...
    ['В западном углу, проверка внимания +5', 'В трупе на центральном острове',
        ...
        'В самом центре локации, проверка внимания +31', 'В комнате напротив центральной'],
